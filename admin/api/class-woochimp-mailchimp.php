...
if ( ! class_exists( 'WooChimp_Mailchimp' ) ) {
	...
	class WooChimp_Mailchimp {
		 ...
		 * @return mixed
		 */
		public function get_merge_fields( $list_id, $params = array(
			'count' => 100,
		) ) {
		 ...
		 * @return mixed
		 */
		public function get_interest_categories( $list_id, $params = array(
			'count' => 100,
		) ) {
		 ...
		 * @return mixed
		 */
		public function get_interests( $list_id, $category_id, $params = array(
			'count' => 100,
		) ) {
		 ...
		 * @return mixed
		 */
		public function get_customers( $store_id, $params = array(
			'count' => 1000,
		) ) {
